...
public class program02 {
	public static void main(String[] args) {
      ...
      //  System.out.println(x.get(3));//Get function
        ...
        Integer a[]= {20,40,90};
        System.out.println("a - "+x.containsAll(Arrays.asList(a)));//to verify all the values of a is in x or not 
	    Integer b[]= {10,20,99};
	    System.out.println("b - "+x.containsAll(Arrays.asList(b)));//to verify all the values of b is in x or not 
